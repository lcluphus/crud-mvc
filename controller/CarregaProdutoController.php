	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.php"><span class="glyphicon glyphicon-shopping-cart"></span> </a>
			</div>
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					<li><a href="adiciona-produto.php"> <span class="glyphicon glyphicon-plus"></span> Adicionar Produto</a></li>
					<li><a href="index.php"> <span class="glyphicon glyphicon-th-list"></span> Lista de Produtos</a></li>
